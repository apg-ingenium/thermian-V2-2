...
def visualize_boxes_and_labels_on_image_array(
    ...
    Args:
      ...
      color: color used to draw bounding boxes and label backgrounds
      text_color: color used to draw the text of the labels
...
def draw_bounding_box_on_image_array(
    ...
    draw_bounding_box_on_image(
        image_pil, ymin, xmin, ymax, xmax, color,
...
def draw_bounding_box_on_image(
    ...
    Args:
      ...
      use_normalized_coordinates: If True (default), treat coordinates
        ymin, xmin, ymax, xmax as relative to the image.  Otherwise treat
        coordinates as absolute.
      text_color: color used to write the text of the label
    """
    ...
    if thickness > 0:
        draw.line([(left, top), (left, bottom), (right, bottom), (right, top), (left, top)], width=thickness,
                  fill=color)
    try:
        font = ImageFont.truetype('/app/assets/Roboto.ttf', 12)
    except IOError:
